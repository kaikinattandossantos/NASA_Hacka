          ...
          <div className='grid grid-cols-2 gap-2 w-full'>
            ...
            <div className='flex flex-row items-center justify-center bg-main-degrade text-white rounded-lg w-auto h-auto p-5 shadow-lg'>
              ...
              <div className='flex flex-col items-start justify-center'>
                ...
                <a href="https://www.linkedin.com/in/paulotruly" target='_blank' className='w-auto h-[20px] mt-2'>
                  {/* Ícone removido */}
                </a>
              </div>
            </div>
            ...
            <div className='flex flex-row items-center justify-center bg-main-degrade text-white rounded-lg w-auto h-auto p-5 shadow-lg'>
                ...
                <div className='flex flex-col items-start justify-center'>
                    ...
                    <a href="https://www.linkedin.com/in/kaikinattan" target='_blank' className='w-auto h-[20px] mt-2'>
                      {/* Ícone removido */}
                    </a>
                </div>
            </div>
            ...
            <div className='flex flex-row items-center justify-center bg-main-degrade text-white rounded-lg w-auto h-auto p-5 shadow-lg'>
                ...
                <div className='flex flex-col items-start justify-center'>
                    ...
                    <p className='font-normal text-[12px]'> Front-end developer </p>
                    <a href="https://www.linkedin.com/in/joao-rafaell" target='_blank' className='w-auto h-[20px] mt-2'>
                      {/* Ícone removido */}
                    </a>
                </div>
            </div>
            ...
            <div className='flex flex-row items-center justify-center bg-main-degrade text-white rounded-lg w-auto h-auto p-5 shadow-lg'>
                ...
                <div className='flex flex-col items-start justify-center'>
                    ...
                    <a href="https://www.linkedin.com/in/ester-hsnt" target='_blank' className='w-auto h-[20px] mt-2'>
                      {/* Ícone removido */}
                    </a>
                </div>
            </div>
            ...
            <div className='flex flex-row items-center justify-center bg-main-degrade text-white rounded-lg w-auto h-auto p-5 shadow-lg'>
                ...
                <div className='flex flex-col items-start justify-center'>
                    ...
                    <a href="https://www.linkedin.com/in/maximus-bragança" target='_blank' className='w-auto h-[20px] mt-2'>
                      {/* Ícone removido */}
                    </a>
                </div>
            </div>
